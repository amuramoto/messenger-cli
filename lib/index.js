...
program  
  .command('mock')
  .description('Sends mock events to your webhook, so you can test your bot.')
  .option('-t, --type <type>', 'The type of webhook event to send. Examples: messages, messaging_postbacks')
  .option('-w, --webhook [address]', 'The webhook URL to send the event to. May also be set in MESSENGER_WEBHOOK_URL environment variable.')
